...
set_target_properties(flann::flann_cpp PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/flann_cpp.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "-Wl,--push-state,--no-as-needed;-Wl,--pop-state"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/flann_cpp.dll"
  )
...
set_target_properties(flann::flann_cpp_s PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/flann_cpp_s.lib"
  )
...
# Import target "flann::flann_cuda" for configuration "Debug"
set_property(TARGET flann::flann_cuda APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(flann::flann_cuda PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/flann_cuda.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v10.2/lib/x64/cudart_static.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/flann_cuda.dll"
  )
...
# Import target "flann::flann_cuda_s" for configuration "Debug"
set_property(TARGET flann::flann_cuda_s APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(flann::flann_cuda_s PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v10.2/lib/x64/cudart_static.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/flann_cuda_s.lib"
  )
...
set_target_properties(flann::flann PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/flann.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "-Wl,--push-state,--no-as-needed;-Wl,--pop-state"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/flann.dll"
  )
...
set_target_properties(flann::flann_s PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "-Wl,--push-state,--no-as-needed;-Wl,--pop-state"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/flann_s.lib"
  )
